...
public class Receipt implements Printable {
	 ...
	 * @param plan                  - the patient's health plan
	 * @param payingTreatments      - a list of treatments to be paid
	 * @param treatmentsLeft        - a list of treatments to be paid later
	...
	public int print(Graphics g, PageFormat pageFormat, int pageIndex) throws PrinterException {
		...
		HashMap<Integer, TreatmentApplication> modelMap = new HashMap<>();
